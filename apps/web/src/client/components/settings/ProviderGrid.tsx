...
import type { ProviderId, ProviderSettings } from '@zmeel/agent-core/common';
...
export function ProviderGrid({
  ...
  // Check build capabilities on mount to determine if zmeel-ai should be shown
  useEffect(() => {
    let cancelled = false;
    getZmeel()
  ...
  const filteredProviders = useMemo(() => {
    ...
    // Hide zmeel-ai when the build does not support free mode
    if (hasFreeMode === false) {
      providers = providers.filter((id) => id !== 'zmeel-ai');
    }
