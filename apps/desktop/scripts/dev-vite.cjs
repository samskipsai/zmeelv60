 ...
 * Sets ZMEEL_ROUTER_URL environment variable and starts Vite.
 *
...
process.env.ZMEEL_ROUTER_URL = 'http://localhost:5173';
...
console.log('[dev-vite] Starting Vite with ZMEEL_ROUTER_URL=http://localhost:5173');
