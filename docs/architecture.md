...
packages/agent-core/     # Core business logic, shared types, MCP tools (published as @zmeel/agent-core)
```

- `index.ts` - Electron bootstrap, single-instance enforcement, `zmeel://` protocol handler
